...
class CoachProfileCard extends StatelessWidget {
  ...
  const CoachProfileCard({super.key,this.rating, this.coachName, this.coachLocation, this.coachImg, this.coachSportImg, this.onTap});
              ...
              children: [
                ...
                Row(
                  children: [
                   ...
                   2.width,
                    Image(image: NetworkImage(coachSportImg!),height: 20,width: 20,),
                    const Spacer(),
                    kTextButton(
                      onPressed: () {},
                      btnText: 'View More',
